...
const createReactClassPageWithExtras = require("../../components/classes/extras/page.extras");
...
module.exports = async (name) => {
	...
	createReactClassPageWithExtras(name, state, componentDidMount, componentDidUpdate);
};
